...
- [Example workflow simple (toy problem)](#example-workflow-simple-(intercellular-communication-in-a-toy-single-cell-dataset))
...
- [Example workflow advanced (Tabula Muris Senis dataset)](#example-workflow-simple-(intercellular-communication-in-a-toy single-cell-dataset)
